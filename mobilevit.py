...
class MobileViT(nn.Module):
    ...
    """
    def __init__(self, model_cfg: Dict, in_channels = 3):
        super().__init__()
        ...
        self.layer_33_, out_channels = self._make_layer(input_channel=24, cfg=model_cfg["layer_33_"])
        self.layer_34_, out_channels = self._make_layer(input_channel=24, cfg=model_cfg["layer_34_"])
        self.layer_35_, out_channels = self._make_layer(input_channel=64, cfg=model_cfg["layer_35_"])
    ...
    def forward(self, x: Tensor) -> Tensor:
        feat1 = self.conv_1(x)
        feat2 = self.layer_1(feat1)
        feat2 = self.layer_2(feat2)
...
def mobile_vit_xx_small():
    ...
    m = MobileViT(config, in_channels = 3)
    return m
